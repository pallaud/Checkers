...
public class CheckersData {
	...
	/**
	 * board[r][c] is the contents of row r, column c.
	 */
	int[][] board;
	 ...
	 * 
	 * @param row
	 *            the row of the piece being returned
	 * @param col
	 *            the col of the piece being returned
	 * @return contents of board in specified row and column
	 */
	...
	/**
	 * Set the contents of the square in the specified row and column. piece
	 * must be one of the constants EMPTY, RED, BLACK, RED_KING, BLACK_KING.
	 * 
	 * @param row
	 *            the row of the piece being set
	 * @param col
	 *            the col of the piece being set
	 * @param piece
	 *            to be set
	 */
	 ...
	 * 
	 * @param move
	 *            The move that a piece will make
	 */
	public void makeMove(CheckersMove move) {
		makeMove(move.fromRow, move.fromCol, move.toRow, move.toCol, move);
	}

	/**
	 * Make the move from (fromRow,fromCol) to (toRow,toCol). It is assumed that
	 * this move is legal. If the move is a jump, the jumped piece is removed
	 * from the board. If a piece moves to the last row on the opponent's side
	 * of the board, the piece becomes a king.
	 * 
	 * @param fromRow
	 *            the row from which the piece is moved
	 * @param fromCol
	 *            the col from which the piece is moved
	 * @param toRow
	 *            the row to which the piece is moved
	 * @param toCol
	 *            the col to which the piece is moved
	 * @param m
	 *            the move itself
	 */
	 ...
	 * returned. The value of player should be one of the constants RED or
	 * BLACK; if not, null is returned. If the returned value is non-null, it
	 * consists entirely of jump moves or entirely of regular moves, since if
	 * the player can jump, only jumps are legal moves.
	 * 
	 * @param player
	 *            is the type of player (red, red king, black, black king)
	...
	public CheckersMove[] getLegalMoves(int player) {
		...
		ArrayList<CheckersMove> moves = new ArrayList<CheckersMove>(); // stores
																		// possible
																		// moves
		 ...
		 * moves from the ArrayList into the array, and return the array.
		 */
	 ...
	 *            is the type of player (red, red king, black, black king)
	 * @param row
	 *            is the row the piece jumps from
	 * @param col
	 *            is the col the piece jumps from
	 * @return an array of all the possible jump moves
	 */
	 ...
	 *            is the type of player (red, red king, black, black king)
	 * @param r1
	 *            the row position the piece can jump from
	 * @param c1
	 *            the col position the piece can jump from
	 * @param r2
	 *            the row position the piece can jump over
	 * @param c2
	 *            the col position the piece can jump over
	 * @param r3
	 *            the row position the piece can jump to
	 * @param c3
	 *            the col position the piece can jump to
	 * @return whether the piece can make a legal jump or not
	 */
	public boolean canJump(int player, int r1, int c1, int r2, int c2, int r3,
			int c3) {
	 ...
	 *            is the type of player (red, red king, black, black king)
	 * @param r1
	 *            the row position the piece can move from
	 * @param c1
	 *            the col position the piece can move from
	 * @param r2
	 *            the row position the piece can move to
	 * @param c2
	 *            the col position the piece can move to
	 * @return whether the piece can make a legal move or not
	 */
